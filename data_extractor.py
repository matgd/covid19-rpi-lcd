...
def get_cases():
    ...
    total_name, total_cases, total_new, _, _, total_recovered, total_active = total_table_row[0:7]
    ...
    poland_name, poland_cases, poland_new, _, _, poland_recovered, poland_active = poland_table_row[0:7]
